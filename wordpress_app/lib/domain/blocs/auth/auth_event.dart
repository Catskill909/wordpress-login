...
class RequestRegistrationCodeEvent extends AuthEvent {
  final String email;

  const RequestRegistrationCodeEvent({
    required this.email,
  });
...
class VerifyRegistrationEvent extends AuthEvent {
  final String email;
  final String code;

  const VerifyRegistrationEvent({
    required this.email,
    required this.code,
  });
